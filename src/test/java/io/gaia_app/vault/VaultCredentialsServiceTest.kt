...
class VaultCredentialsServiceTest {
    ...
    fun findAzureRMCredentials_shouldReturnDecryptedCredentials() {
        val encryptedAzureRMCredentials = AzureRMCredentials("encryptedClientId", "encryptedSecret", "encryptedSubscriptionId", "encryptedTenantId", "encryptedBackendAccessKey", "encryptedEnvironment")
        val plainAzureRMCredentials = AzureRMCredentials("clientId", "secret", "subscriptionId", "tenantId", "backendAccessKey", "environment")
